...
if __name__=="__main__":
    ...
    parser.add_argument("-l", '--min_len', help="Discard any read which is shorter than min length kbp.", default=1000,type=int)
    parser.add_argument("-per", '--percent', help="Throw out the worst 100-perecnt of reads.", default=90,type=int)
    args=parser.parse_args()
    run(args.nano,args.outdir,args.prefix,args.min_len,args.percent,args.pe1,args.pe2)
